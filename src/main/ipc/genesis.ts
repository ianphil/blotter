...
export function setupGenesisIPC(
  ...
  ipcMain.handle(
    ...
    withValidation('genesis:getDefaultPath', GenesisGetDefaultPathArgs, async () => {
  ...
  ipcMain.handle(
    'genesis:pickPath',
    withValidation('genesis:pickPath', GenesisPickPathArgs, async (event: Electron.IpcMainInvokeEvent) => {
  ...
  ipcMain.handle(
    'genesis:create',
    withValidation('genesis:create', GenesisCreateArgs, async (event: Electron.IpcMainInvokeEvent, config) => {
      const win = BrowserWindow.fromWebContents(event.sender);
